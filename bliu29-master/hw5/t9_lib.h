 ...
 * invalid words, as defined by AddWordToT9, are skipped.  Note also that an
 * empty but existing dictionary file will return a pointer to an empty T9.
 */
 ...
 * valid C string, or NULL.
 * 
 * Post: If "nums" is NULL, NULL is returned. If "nums" is empty (""),
 * NULL is return.  If "nums" contains any characters other than 
 * digits zero ("0") through nine ("9") and the pound ("#") sign,
