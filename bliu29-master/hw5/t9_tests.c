...
suite("T9") {
  ...
  test("Initialize from empty file") {
  ...
  test("Initialize from file with duplicate words") {
    T9* dict1 = InitializeFromFileT9("dup.txt");
    safe_assert(dict1 != NULL);
    
    T9* dict2 = InitializeEmptyT9();
    safe_assert(dict2 != NULL);

    AddWordToT9(dict2, "cool");

    safe_assert(sizeof(dict1)==sizeof(dict2));

    AssertReturnedStringEquals(PredictT9(dict1, "2665"), PredictT9(dict2, "2665"));
    safe_assert(PredictT9(dict1, "2665#")==NULL);
  ...
  test("Initialize from file with invalid words") {
    T9* dict1 = InitializeFromFileT9("invalid.txt");
    safe_assert(dict1 != NULL);
  ...
  test("Check if all words are added from file") {
    T9* dict1 = InitializeFromFileT9("small.txt");
    safe_assert(dict1 != NULL);
    ...
    AddWordToT9(dict2, "abc");
    AddWordToT9(dict2, "def");
